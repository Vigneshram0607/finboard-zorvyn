...
const ICONS: Record<string, string> = {
  ...
  'arrow-up': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/></svg>`,
  'arrow-down': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/></svg>`,
  ...
  'wallet': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 12V22H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h16v4"/><path d="M20 12a2 2 0 0 0-2-2H4"/><circle cx="17" cy="12" r="1" fill="currentColor"/></svg>`,
  ...
  'piggy-bank': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 11V9a7 7 0 0 0-14 0v2a4 4 0 0 0-1 2.7V15a2 2 0 0 0 2 2h1l1 3h4l1-3h1a2 2 0 0 0 2-2v-1.3A4 4 0 0 0 19 11z"/><circle cx="9" cy="11" r="1" fill="currentColor"/><line x1="19" y1="7" x2="22" y2="7"/></svg>`,
...
@Component({
  selector: 'svg-icon',
  template: '<span [innerHTML]="svg" class="svg-icon-wrap"></span>',
  styles: [`
    :host { display: inline-flex; align-items: center; justify-content: center; }
    .svg-icon-wrap { display: flex; align-items: center; }
...
export class SvgIconComponent implements OnChanges {
  ...
  ngOnChanges(): void {
    const raw = ICONS[this.name] ?? ICONS['alert'];
